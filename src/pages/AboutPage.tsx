...
import { Mail, BookOpen, Award, MessageSquare, Palette, Heart, Star } from 'lucide-react';
    ...
    <div className="bg-primary-50 min-h-screen">
      <div className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 font-display">Meet T.L. Aurely</h1>
          ...
          <div className="md:flex">
            <div className="md:w-1/3 bg-gradient-to-br from-primary-100 to-primary-200 flex justify-center items-center p-8">
              <div className="relative">
                <div className="absolute -inset-4 bg-accent-300 rounded-full transform rotate-6"></div>
                <img 
                  ...
                  alt="T.L. Aurely"
                  className="relative rounded-full shadow-xl h-64 w-64 object-cover z-10 border-4 border-white"
                />
            ...
            <div className="md:w-2/3 p-8">
              <h2 className="text-3xl font-bold mb-2 font-display text-primary-800">T.L. Aurely</h2>
              <p className="text-secondary-600 italic mb-6">Award-winning children's book author & educator</p>
